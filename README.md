...
https://github.com/user-attachments/assets/48e0a914-c480-440d-a753-5d981a7d0863
...
![IMG_9927](https://github.com/user-attachments/assets/8e82b167-a0a6-48f4-8d64-fbd49e87cab7)
...
![IMG_9926](https://github.com/user-attachments/assets/eb5039b7-f83a-4348-aad9-a89240a6e114)
...
추가 자료 조사 결과, 아두이노가 최대로 인식할 수 있는 SD카드의 최대 용량이 32기가임을 알게 되었고,  
...
실제 자동차에 적용시키기 힘들어 미니어처, 모형으로 제작하여 연구 적용 예정입니다. – 김영우

데이터 삭제할 때 오래된 파일부터 삭제가 정상적으로 수행 되지 않아 앞으로 코드를 수정할 계획입니다.(delete_old_data.ino참조) – 박기범 5, 김채환 5

SD카드에 저장되는 데이터를 최대 파일 개수를 설정하여 최대 파일 개수에 도달하면 오래된 순서대로 삭제되는 코드이지만, 현재 파일 열기 실패 오류가 발생했습니다.
SD카드 용량 때문에 생기는 문제일 수 있어, 다른 SD카드를 구매, 추후 개선 예정입니다..(prevent_SUA.ino의 'amend error' commit 참조) - 김영우

우리 팀이 사용하는 SD라이브러리가 인식 가능한 최대 용량이 2GB임을 알았고, 
SD카드를 2GB로 재차 바꾸어 진행해 본 결과 정상적으로 작동했습니다. - 박기범
